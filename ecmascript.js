...
case 119:
            ...
            this.$ = {key: $$[$0-2], value: $$[$0], kind: "init", type: 'ObjectProperty'};
        
break;
case 120:

            if ($$[$0-6] === "get") {
                this.$ = {key: $$[$0-5], value: (new FunctionExpressionNode(null, [], $$[$0-1], false, false, createSourceLocation(null, _$[$0-5], _$[$0]))), kind: "get", type: 'ObjectProperty'};
            } else {
...
case 121:
            ...
            if ($$[$0-7] === "set") {
                this.$ = {key: $$[$0-6], value: (new FunctionExpressionNode(null, $$[$0-4], $$[$0-1], false, false, createSourceLocation(null, _$[$0-6], _$[$0]))), kind: "set", type: 'ObjectProperty'};
            } else {
